...
namespace Stompbox
{
    ...
    public partial class Ili9341 : GraphicDisplay
    {
        ...
        internal const byte LcdPortraitConfig = (byte)(Ili9341Command.ColorFormatBGR | Ili9341Command.ColumnAddressOrder);
        internal const byte LcdLandscapeConfig = (byte)(Ili9341Command.ColorFormatBGR | Ili9341Command.RowColumnExchange);
        internal const byte LcdLandscapeConfigInverted = (byte)(Ili9341Command.ColorFormatBGR | Ili9341Command.RowColumnExchange | Ili9341Command.ColumnAddressOrder | Ili9341Command.RowAddressOrder);
        ...
        {
            SendCommand(Ili9341Command.MemoryAccessControl, LcdLandscapeConfigInverted);
